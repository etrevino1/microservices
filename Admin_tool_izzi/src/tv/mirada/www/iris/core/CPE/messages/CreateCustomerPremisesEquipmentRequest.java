/**
 * CreateCustomerPremisesEquipmentRequest.java
 *
...
public class CreateCustomerPremisesEquipmentRequest  implements java.io.Serializable {
    private tv.mirada.www.iris.core.types.CustomerPremisesEquipment customerPremisesEquipment;

    public CreateCustomerPremisesEquipmentRequest() {
    }
    ...
    /**
     * Gets the customerPremisesEquipment value for this CreateCustomerPremisesEquipmentRequest.
     * 
    ...
    /**
     * Sets the customerPremisesEquipment value for this CreateCustomerPremisesEquipmentRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateCustomerPremisesEquipmentRequest)) return false;
        CreateCustomerPremisesEquipmentRequest other = (CreateCustomerPremisesEquipmentRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCustomerPremisesEquipmentRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/CPE/messages", ">CreateCustomerPremisesEquipmentRequest"));
