/**
 * CreateCustomerPremisesEquipmentTypeRequest.java
 *
...
public class CreateCustomerPremisesEquipmentTypeRequest  implements java.io.Serializable {
    private tv.mirada.www.iris.core.types.CustomerPremisesEquipmentType customerPremisesEquipmentType;

    public CreateCustomerPremisesEquipmentTypeRequest() {
    }
    ...
    /**
     * Gets the customerPremisesEquipmentType value for this CreateCustomerPremisesEquipmentTypeRequest.
     * 
    ...
    /**
     * Sets the customerPremisesEquipmentType value for this CreateCustomerPremisesEquipmentTypeRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateCustomerPremisesEquipmentTypeRequest)) return false;
        CreateCustomerPremisesEquipmentTypeRequest other = (CreateCustomerPremisesEquipmentTypeRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCustomerPremisesEquipmentTypeRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/CPE/messages", ">CreateCustomerPremisesEquipmentTypeRequest"));
