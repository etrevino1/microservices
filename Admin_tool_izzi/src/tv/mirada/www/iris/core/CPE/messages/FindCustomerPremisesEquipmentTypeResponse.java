/**
 * FindCustomerPremisesEquipmentTypeResponse.java
 *
...
public class FindCustomerPremisesEquipmentTypeResponse  implements java.io.Serializable {
    private tv.mirada.www.iris.core.types.CustomerPremisesEquipmentType customerPremisesEquipmentType;

    public FindCustomerPremisesEquipmentTypeResponse() {
    }
    ...
    /**
     * Gets the customerPremisesEquipmentType value for this FindCustomerPremisesEquipmentTypeResponse.
     * 
    ...
    /**
     * Sets the customerPremisesEquipmentType value for this FindCustomerPremisesEquipmentTypeResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof FindCustomerPremisesEquipmentTypeResponse)) return false;
        FindCustomerPremisesEquipmentTypeResponse other = (FindCustomerPremisesEquipmentTypeResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(FindCustomerPremisesEquipmentTypeResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/CPE/messages", ">FindCustomerPremisesEquipmentTypeResponse"));
