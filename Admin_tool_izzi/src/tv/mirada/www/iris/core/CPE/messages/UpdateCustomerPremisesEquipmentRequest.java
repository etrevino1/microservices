/**
 * UpdateCustomerPremisesEquipmentRequest.java
 *
...
public class UpdateCustomerPremisesEquipmentRequest  implements java.io.Serializable {
    private tv.mirada.www.iris.core.types.CustomerPremisesEquipment customerPremisesEquipment;

    public UpdateCustomerPremisesEquipmentRequest() {
    }
    ...
    /**
     * Gets the customerPremisesEquipment value for this UpdateCustomerPremisesEquipmentRequest.
     * 
    ...
    /**
     * Sets the customerPremisesEquipment value for this UpdateCustomerPremisesEquipmentRequest.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateCustomerPremisesEquipmentRequest)) return false;
        UpdateCustomerPremisesEquipmentRequest other = (UpdateCustomerPremisesEquipmentRequest) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateCustomerPremisesEquipmentRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/CPE/messages", ">UpdateCustomerPremisesEquipmentRequest"));
