...
public class CreateSubscriberResponse  implements java.io.Serializable {
    ...
    /**
     * Gets the irisSubscriberId value for this CreateSubscriberResponse.
     * 
    ...
    /**
     * Sets the irisSubscriberId value for this CreateSubscriberResponse.
     * 
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/subscriber/messages", ">CreateSubscriberResponse"));
