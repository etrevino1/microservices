...
public class ServicesServiceLocator extends org.apache.axis.client.Service implements tv.mirada.www.iris.core.types.ServicesService {
    ...
    private java.lang.String ServicesSoap11_address = "http://172.20.183.55:8888/managetv/prov/services/";
    ...
    public tv.mirada.www.iris.core.types.Services getServicesSoap11() throws javax.xml.rpc.ServiceException {
    ...
    public tv.mirada.www.iris.core.types.Services getServicesSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            tv.mirada.www.iris.core.types.ServicesSoap11Stub _stub = new tv.mirada.www.iris.core.types.ServicesSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (tv.mirada.www.iris.core.types.Services.class.isAssignableFrom(serviceEndpointInterface)) {
                tv.mirada.www.iris.core.types.ServicesSoap11Stub _stub = new tv.mirada.www.iris.core.types.ServicesSoap11Stub(new java.net.URL(ServicesSoap11_address), this);
                _stub.setPortName(getServicesSoap11WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/types", "ServicesService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://www.mirada.tv/iris/core/types", "ServicesSoap11"));
        }
